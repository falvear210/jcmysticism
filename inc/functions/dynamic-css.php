...
if ( ! function_exists( 'aeonblog_dynamic_css' ) ) {
	...
	function aeonblog_dynamic_css() {
		...
		$aeonblog_body_font           = esc_attr( get_theme_mod( 'aeonblog_body_font', 'Source Sans Pro' ) );
		$aeonblog_title_font          = esc_attr( get_theme_mod( 'aeonblog_title_font', 'Libre Baskerville' ) );
		$aeonblog_font_size           = absint( get_theme_mod( 'aeonblog-font-size', 16 ) );
		$aeonblog_font_line_height    = esc_attr( get_theme_mod( 'aeonblog-font-line-height', 1.4 ) );
		...
		$aeonblog_accent_color        = esc_attr( get_theme_mod( 'aeonblog-accent-color', '#25274D' ) );
		$aeonblog_button_color        = esc_attr( get_theme_mod( 'aeonblog-button-color', '#b8b8b8' ) );
		$custom_css                   = '';
